...
public:
  ...
  void init();
  nav_msgs::OccupancyGrid latest_predicted_map_;
...
private:
  ...
  void predictedMapCallback(const nav_msgs::OccupancyGridConstPtr& msg);
...
// 深度 + Odom 同步
  ...
  typedef std::shared_ptr<message_filters::Synchronizer<SyncPolicyCloudPose>>
  ...
  ros::Subscriber predicted_map_sub_;

  ros::Publisher map_local_pub_, map_local_inflate_pub_, esdf_pub_, map_all_pub_, unknown_pub_,
      update_range_pub_, depth_pub_, map_2d_pub_, map_image_pub_;
